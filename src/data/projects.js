const projects = [
  ...
  },
  {
    ...
    descriptionFull:
      "As the sole developer and visionary behind Subula Shopping App, I embarked on the journey to create a modern and efficient shopping platform. Leveraging React and Firebase, I crafted a seamless user experience where users can log in securely via email, password, or Google authentication. The app's design prioritizes simplicity and intuitiveness, allowing users to effortlessly browse and purchase their favorite products. From ideation to deployment, I took on the responsibility of every phase in the project lifecycle. Subula Shopping App stands as a testament to my dedication to delivering a reliable and innovative mobile shopping solution.",
    tech: [
      "REACT",
      "CONTEXT API",
      "FIREBASE",
    ...
    profilePhoto: "images/subula.png",
    photos: [
      "subula001.png",
      "subula002.png",
      "subula003.png",
    ...
    websiteURL: "https://subula.netlify.app/",
    codeURL: "https://github.com/Edgar256/subula-web-app",
    role: "WEB DEVELOPER",
    roleRecap:
      "As the sole developer, I conceptualized, designed, and implemented the entire Subula Shopping App from scratch. Over a period of two years, I not only built the application but also maintained it, ensuring its stability and success. In addition to development, I took on the role of a mentor for myself, continually improving my skills and knowledge of front-end technologies.",
    contribution: [
      "Conceptualized and implemented the entire Subula Shopping App as the sole developer.",
      "Designed and developed the user interface, ensuring a seamless and intuitive shopping experience.",
      "Implemented authentication features, allowing users to log in using email, password, or Google authentication.",
      "Utilized React,Context API and Firebase to create a responsive and efficient mobile application.",
      "Personally managed the entire project lifecycle, from ideation to deployment.",
      "Solely conducted code reviews, maintaining high code quality and consistency throughout the development process.",
      "Collaborated with designers to meet visual and functional requirements, ensuring an appealing user interface.",
      "Established and maintained a style guide for consistent design and code practices.",
      "Regularly communicated project updates and progress in stand-up meetings.",
      "Ensured thorough testing of all features before release, guaranteeing a stable and reliable application.",
      "Created and maintained comprehensive documentation for the entire development process.",
      "Advocated for accessibility and responsive design principles to enhance usability for a broad user base.",
      "Successfully delivered Subula Shopping App within project timelines and budget constraints.",
    ],
  },
  {
    id: 4,
